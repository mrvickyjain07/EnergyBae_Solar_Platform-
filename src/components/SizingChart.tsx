...
export default function SizingChart({ history, solarSizeKw }: SizingChartProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="glass-panel rounded-2xl p-5 border-[var(--border-subtle)] relative overflow-hidden transition-colors duration-300">
            ...
            {history.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {hoveredIdx === idx && (
                    <div className="absolute bottom-[105%] left-1/2 -translate-x-1/2 bg-[var(--bg-primary)]/95 border border-[var(--accent-blue)]/40 px-3 py-2 rounded-xl shadow-2xl z-20 min-w-[140px] pointer-events-none text-left backdrop-blur-lg">
                      ...
                      <div className="space-y-1 text-xs">
                        <div className="flex justify-between gap-4">
                          ...
                          <span className="text-[var(--accent-blue)] font-mono font-medium">{item.consumption} Units</span>
                        </div>
                        <div className="flex justify-between gap-4">
